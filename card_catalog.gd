...
const KINDS: Array[String] = [
	"punch", "slash", "shot", "charged_slash", "roll", "blink", "jet_jump",
...
const CARDS: Dictionary = {
	...
	"slash": {"name": "劈砍", "category": "attack", "cost": 2.0, "effect": "向前方扇形挥刀\n可与翻滚衔接"},
	...
	"dash_slash": {"name": "冲刺挥砍", "category": "hybrid", "cost": 5.0, "effect": "快速向前突进\n接近敌人并挥斩"},
